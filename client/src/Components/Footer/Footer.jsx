...
function Footer() {
  return (
    <div className=' box-border sm:mt-5 bg-LightBlack sm:w-[100%]'>
      ...
      <div>
        <h3 className='md:ml-[2rem] sm:ml-[4rem] sm:mt-6  sm:text-white sm:text-sm'>Information</h3>
      ...
      <div>
        <h3 className='md:mt-[-5rem] sm:text-right sm:mr-[3rem] sm:mt-[-4.5rem] sm:text-white sm:text-sm '>My Account</h3>
      ...
      <div >
        <h3 className='md:mt-[-5.5rem] md:ml-[18rem] sm:text-center sm:mt-[2rem] sm:text-sm text-white'>Social</h3>
        <div className='md:ml-[68%] md:mt-1 md:gap-2 sm:ml-[47%] sm:w-8 items-center justify-center sm:gap-8 flex' >
