  ...
  return (
    <div className='sticky top-0 z-10 h-[2.5rem] bg-white overflow-y-hidden overflow-x-hidden'>
      ...
      <nav className='lg:mt-[-2.5rem] lg:visible sm:invisible flex'>
        ...
        <img className='xl:ml-[-9.5rem] lg:w-[8rem] lg:h-9 lg:ml-[-9.2rem] opacity-0 transition-opacity duration-300 transform hover:opacity-100' src={redwolftitlegif} alt="" />
